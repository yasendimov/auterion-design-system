...
<template>
  <div>
      ...
      <div class="grid gap-6 sm:grid-cols-2">
        <div>
          <div class="aspect-video bg-surface-1 flex items-center justify-center">
            <span class="text-sm text-dim">Swarm in formation over terrain — calm, controlled, precise</span>
          </div>
          <p class="text-xs text-low mt-2">Conveys operational confidence and technological mastery.</p>
        </div>
        <div>
          <div class="aspect-video bg-surface-1 flex items-center justify-center">
            <span class="text-sm text-dim">Operator reviewing fleet data at sunrise</span>
          </div>
          <p class="text-xs text-low mt-2">Human element grounds the technology in purpose and context.</p>
        </div>
      </div>
    </section>
    ...
    <section class="px-10 lg:px-20 py-24">
      ...
      <div class="space-y-6 max-w-3xl">
        <div class="border-l-2 border-primary pl-5">
          <h3 class="text-sm font-semibold text-high mb-1">Rule of Thirds</h3>
          <p class="text-sm text-low leading-relaxed">Place primary subjects at intersection points. Drones and operators should rarely be dead center unless conveying direct confrontation or symmetry.</p>
        </div>
        <div class="border-l-2 border-primary pl-5">
          <h3 class="text-sm font-semibold text-high mb-1">Negative Space for Text Overlay</h3>
          <p class="text-sm text-low leading-relaxed">When shooting for marketing use, ensure at least one third of the frame is clean sky, ground, or blurred background suitable for headline placement.</p>
        </div>
        <div class="border-l-2 border-primary pl-5">
          <h3 class="text-sm font-semibold text-high mb-1">Depth and Layers</h3>
          <p class="text-sm text-low leading-relaxed">Use foreground elements (terrain, equipment, people) to create depth. Swarms in the mid-ground with landscape beyond conveys scale.</p>
        </div>
        <div class="border-l-2 border-primary pl-5">
          <h3 class="text-sm font-semibold text-high mb-1">Leading Lines</h3>
          <p class="text-sm text-low leading-relaxed">Runways, roads, flight paths, and formation lines naturally guide the viewer's eye toward the subject.</p>
        </div>
      </div>
    </section>
    ...
    <section class="px-10 lg:px-20 py-24">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div class="p-8 border border-line">
          ...
          <div class="aspect-video bg-surface-1 flex items-center justify-center mt-4">
        ...
        <div class="p-8 border border-line">
          ...
          <div class="aspect-video bg-surface-1 flex items-center justify-center mt-4">
            <span class="text-sm text-dim">Skynode PCB macro detail</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="px-10 lg:px-20 py-24">
      ...
      <div class="grid gap-6 sm:grid-cols-2">
        <div>
          <div class="aspect-video bg-ok-subtle border border-ok-border flex items-center justify-center">
            <span class="text-sm text-ok-text">Natural light, real environment, muted grade</span>
          </div>
          <div class="flex items-center gap-2 mt-3">
            <span class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-ok-muted text-ok-text text-xs font-bold">&#10003;</span>
            <p class="text-sm font-medium text-high">Do: Authentic field conditions</p>
          </div>
          <p class="text-xs text-low mt-1 ml-7">Real operational environments with natural lighting. Desaturated backgrounds that let brand colors stand out.</p>
        </div>
        <div>
          <div class="aspect-video bg-alarm-subtle border border-alarm-border flex items-center justify-center">
            <span class="text-sm text-alarm-text">Heavy HDR, neon color grading, stock photo look</span>
          </div>
          <div class="flex items-center gap-2 mt-3">
            <span class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-alarm-muted text-alarm-text text-xs font-bold">&#10007;</span>
            <p class="text-sm font-medium text-high">Don't: Over-processed imagery</p>
          </div>
          <p class="text-xs text-low mt-1 ml-7">Avoid heavy HDR, dramatic color grading, artificial lens flares, or generic stock photography aesthetics.</p>
        </div>
        <div>
          <div class="aspect-video bg-ok-subtle border border-ok-border flex items-center justify-center">
            <span class="text-sm text-ok-text">Clear negative space, rule-of-thirds subject</span>
          </div>
          <div class="flex items-center gap-2 mt-3">
            <span class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-ok-muted text-ok-text text-xs font-bold">&#10003;</span>
            <p class="text-sm font-medium text-high">Do: Intentional composition</p>
          </div>
          <p class="text-xs text-low mt-1 ml-7">Structured framing with clear focal points, breathing room for text overlays, and layered depth.</p>
        </div>
        <div>
          <div class="aspect-video bg-alarm-subtle border border-alarm-border flex items-center justify-center">
            <span class="text-sm text-alarm-text">Cluttered frame, no clear subject, dutch angle</span>
          </div>
          <div class="flex items-center gap-2 mt-3">
            <span class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-alarm-muted text-alarm-text text-xs font-bold">&#10007;</span>
            <p class="text-sm font-medium text-high">Don't: Chaotic framing</p>
          </div>
          <p class="text-xs text-low mt-1 ml-7">Avoid cluttered compositions, tilted angles, or images where the primary subject is unclear or competing with background elements.</p>
        </div>
      </div>
    </section>
  </div>
