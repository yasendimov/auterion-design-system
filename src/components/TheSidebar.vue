...
<template>
  <aside class="w-64 h-screen sticky top-0 flex flex-col border-r border-line bg-page shrink-0">
    <!-- Brand -->
    <div class="h-14 px-5 flex items-center justify-between shrink-0 border-b border-line">
      <router-link to="/" class="flex items-center gap-2.5">
        <svg class="h-4 shrink-0 text-high" viewBox="0 0 780 148" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <nav class="flex-1 overflow-y-auto py-4">
      ...
      <div v-for="(section, sIdx) in sections" :key="section.title" class="mt-0.5 first:mt-0">
        ...
        >
          <ul class="overflow-hidden ml-5 pl-7 border-l border-line">
            ...
            <li v-for="subGroup in section.subGroups" :key="subGroup.to" class="mt-1">
              ...
              >
                <ul class="overflow-hidden pl-3 border-l border-line ml-0">
    ...
    <!-- Footer -->
    <div class="px-5 py-3 border-t border-line shrink-0">
      <span class="text-[10px] font-mono text-dim uppercase tracking-[0.15em]">v0.1.0</span>
    </div>
  </aside>
</template>
